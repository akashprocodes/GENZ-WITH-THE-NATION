            ...
            {status === 'COMPLETED' ? (
              ...
              >
                ...
                <p className="text-gray-500 mb-8 leading-relaxed max-w-xs mx-auto text-sm">
                  Welcome to Gen-Z Nation! We have received your details securely. Please proceed to upload your reel.
                </p>
                <Link href="/upload">
                  <button className="w-full sm:w-auto px-10 py-4 bg-[#FF9933] text-white rounded-full font-semibold tracking-widest text-xs uppercase hover:bg-[#e68a2e] hover:shadow-lg transition-all duration-300">
                    Proceed to Upload
                  </button>
                </Link>
              </motion.div>
              ...
              >
                <div className="flex flex-col gap-6">
                  ...
                  {/* 2-Column Grid */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-[10px] border border-black/10 rounded-[32px]">
                    {[
                  ...
                  <div className="flex flex-col gap-3 p-[10px] border border-black/10 rounded-[32px]">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center py-[20px] rounded-full bg-[#1A1A1A] text-white font-bold tracking-[0.15em] uppercase text-[12px] cursor-pointer hover:bg-black hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed mt-4 shadow-lg shadow-black/10"
                  >
                    {status === 'SUBMITTING' ? (
