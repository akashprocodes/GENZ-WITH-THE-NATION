    ...
    <div className="flex flex-col min-h-screen overflow-hidden bg-white text-[#1a1512] font-sans selection:bg-[#C4532B] selection:text-white">
      ...
      <section className="relative min-h-[90vh] pt-16 pb-20 px-6 md:px-12 flex items-center justify-center overflow-hidden bg-[#FAF9F6]">
        ...
        <div className="max-w-[1000px] w-full mx-auto flex flex-col items-center text-center relative z-10 mt-8">
          ...
          <motion.h1
            variants={fadeIn}
            className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight text-[#1A1A1A] mb-8 flex flex-wrap justify-center gap-4"
          >
            <span>Your Reel.</span>
      ...
      <section id="about" className="py-24 px-6 md:px-12 bg-white relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#FAF9F6] rounded-full blur-3xl -z-10 translate-x-1/3 -translate-y-1/3"></div>
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#F4F9F5] rounded-full blur-3xl -z-10 -translate-x-1/3 translate-y-1/3"></div>
        
        <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
            <motion.div variants={fadeIn} className="inline-flex items-center rounded-full bg-[#1A1A1A]/5 text-[#1A1A1A] px-5 py-1.5 text-xs font-medium tracking-widest uppercase mb-8 border border-[#1A1A1A]/5">
              <span className="w-2 h-2 rounded-full bg-[#3A5F45] mr-3"></span>
              About the Movement
            </motion.div>
            <motion.h2 variants={fadeIn} className="font-heading text-4xl md:text-5xl font-medium tracking-tight leading-tight mb-8 text-[#1A1A1A]">
              One reel, one story of what the nation means to you.
            </motion.h2>
            <motion.p variants={fadeIn} className="text-lg font-light leading-relaxed mb-6 text-[#1A1A1A]/80">
            ...
            <motion.p variants={fadeIn} className="text-lg font-light leading-relaxed text-[#1A1A1A]/50">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger} className="lg:pl-8">
            <motion.div variants={fadeIn} className="font-medium uppercase tracking-widest text-sm mb-8 flex items-center gap-3 text-[#1A1A1A]/60">
              <Star className="w-4 h-4 text-[#3A5F45]" /> Themes to build your reel around
            </motion.div>
            <div className="flex flex-col gap-4">
              {[
                ...
                <motion.div variants={fadeIn} key={i} className="flex items-center gap-6 p-6 rounded-2xl bg-white hover:bg-[#FAF9F6] transition-all duration-500 group border border-[#1A1A1A]/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1">
                  <div className="w-14 h-14 rounded-2xl bg-[#FAF9F6] group-hover:bg-white flex items-center justify-center shrink-0 transition-colors duration-500 shadow-sm">
                    <span className="text-2xl group-hover:scale-110 transition-transform duration-500">{theme.icon}</span>
                  </div>
                  <span className="font-medium text-[#1A1A1A]/90 text-lg group-hover:text-[#3A5F45] transition-colors duration-500">{theme.text}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
      ...
      {/* Why Join Grid */}
      <section id="why" className="py-24 px-6 md:px-12 bg-[#FAF9F6] relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto relative z-10">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={stagger} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <motion.div variants={fadeIn} key={i} className="relative bg-white rounded-3xl p-8 hover:-translate-y-2 transition-all duration-500 overflow-hidden group shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(58,95,69,0.08)] border border-[#1A1A1A]/5">
                {/* Gradient subtle glow on hover */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#3A5F45]/0 via-transparent to-[#3A5F45]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                
                <div className="absolute -right-4 -top-6 font-heading text-[140px] font-bold text-transparent bg-clip-text bg-gradient-to-b from-[#1A1A1A]/5 to-transparent z-0 group-hover:scale-110 transition-transform duration-700 pointer-events-none select-none">{card.num}</div>
                
                <div className="w-12 h-12 rounded-full bg-[#FAF9F6] group-hover:bg-[#3A5F45] transition-colors duration-500 mb-6 flex items-center justify-center relative z-10">
                  <span className="text-[#1A1A1A]/40 group-hover:text-white font-medium text-sm transition-colors duration-500">{card.num}</span>
                </div>
                
                <h3 className="text-xl font-medium mb-3 relative z-10 text-[#1A1A1A] group-hover:text-[#3A5F45] transition-colors duration-500">{card.title}</h3>
                <p className="font-light text-[#1A1A1A]/60 relative z-10 leading-relaxed group-hover:text-[#1A1A1A]/80 transition-colors duration-500">{card.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
